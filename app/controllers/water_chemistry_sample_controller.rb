class WaterChemistrySampleController < ApplicationController
  active_scaffold do |config|
    ...
    config.columns = [:created_at, :agency_sample_no, :sample_collection_method, :sample_depth_in_m, :water_source_type, :analyzed_by, :water_chemistry_sample_results]
    config.columns[:created_at].label = "Date Entered"
